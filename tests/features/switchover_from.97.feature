Feature: manual switchover from old master
  ...
  Scenario Outline: switchover from works on healthy cluster
    ...
    And mysql host "{{.new_master}}" should have variable "rpl_semi_sync_source_enabled" set to "1"
    ...
    And mysql host "{{.slave_1}}" should have variable "rpl_semi_sync_replica_enabled" set to "1"
    And mysql host "{{.slave_1}}" should have variable "rpl_semi_sync_source_enabled" set to "0"
    ...
    And mysql host "{{.slave_2}}" should have variable "rpl_semi_sync_replica_enabled" set to "1"
    And mysql host "{{.slave_2}}" should have variable "rpl_semi_sync_source_enabled" set to "0"
  ...
  Scenario Outline: switchover from works with dead slave
    ...
    And mysql host "mysql2" should have variable "rpl_semi_sync_source_enabled" set to "1"
    ...
    And mysql host "mysql1" should have variable "rpl_semi_sync_replica_enabled" set to "1"
    ...
    And mysql host "mysql3" should have variable "rpl_semi_sync_replica_enabled" set to "1" within "3" seconds
  ...
  Scenario: switchover from works with dead master
    ...
    And mysql host "{{.old_slave}}" should have variable "rpl_semi_sync_replica_enabled" set to "1"
    And mysql host "{{.old_slave}}" should have variable "rpl_semi_sync_source_enabled" set to "0"
