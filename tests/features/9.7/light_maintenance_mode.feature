Feature: light maintenance mode behaviour
    ...
    Scenario: Cascade replicas switches between HA-nodes during light maintenance mode
        ...
        And mysql host "mysql2" should have variable "rpl_semi_sync_replica_enabled" set to "1" within "10" seconds
        And mysql host "mysql3" should become replica of "mysql2" within "30" seconds
        And mysql host "mysql3" should have variable "rpl_semi_sync_replica_enabled" set to "0" within "10" seconds
    ...
    Scenario: failover via switch command is suppressed in light maintenance mode
        Given cluster is up and running
        Then mysql host "mysql1" should be master
        And mysql host "mysql2" should be replica of "mysql1"
        And mysql replication on host "mysql2" should run fine within "5" seconds
    ...
    Scenario: switchover works in light maintenance mode
        Given cluster is up and running
        Then mysql host "mysql1" should be master
        And mysql host "mysql2" should be replica of "mysql1"
        And mysql replication on host "mysql2" should run fine within "5" seconds
        ...
        And mysql replication on host "mysql1" should run fine within "5" seconds
