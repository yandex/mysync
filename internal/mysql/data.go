...
func (v *Version) GetStopSlaveQuery() string {
	if v.CheckIfVersionReplicaStatus() {
		return queryStopReplica
	} else {
		return queryStopSlave
	}
}

func (v *Version) GetStartSlaveQuery() string {
	if v.CheckIfVersionReplicaStatus() {
		return queryStartReplica
	} else {
		return queryStartSlave
	}
}

func (v *Version) GetStopSlaveIOThreadQuery() string {
	if v.CheckIfVersionReplicaStatus() {
		return queryStopReplicaIOThread
	} else {
		return queryStopSlaveIOThread
	}
}

func (v *Version) GetStartSlaveIOThreadQuery() string {
	if v.CheckIfVersionReplicaStatus() {
		return queryStartReplicaIOThread
	} else {
		return queryStartSlaveIOThread
	}
}

func (v *Version) GetStopSlaveSQLThreadQuery() string {
	if v.CheckIfVersionReplicaStatus() {
		return queryStopReplicaSQLThread
	} else {
		return queryStopSlaveSQLThread
	}
}

func (v *Version) GetStartSlaveSQLThreadQuery() string {
	if v.CheckIfVersionReplicaStatus() {
		return queryStartReplicaSQLThread
	} else {
		return queryStartSlaveSQLThread
	}
}

func (v *Version) GetResetSlaveQuery() string {
	if v.CheckIfVersionReplicaStatus() {
		return queryResetReplicaAll
	} else {
		return queryResetSlaveAll
	}
}

func (v *Version) GetChangeMasterQuery() string {
	if v.CheckIfVersionReplicaStatus() {
		return queryChangeSource
	} else {
