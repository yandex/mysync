...
func TestFindMostRecentNodeAndDetectSplitbrain(t *testing.T) {
	...
	positions = []nodePosition{
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-101," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100"), "A", 0, 0},
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-100," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100"), "B", 0, 0},
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-100," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100"), "C", 0, 5},
	}
	...
	positions = []nodePosition{
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-100," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100"), "A", 0, 0},
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-102," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-103," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-104"), "B", 0, -5},
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-101," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-102," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-103"), "C", 0, 0},
	}
	host, _, splitbrain = findMostRecentNodeAndDetectSplitbrain(positions)
	...
	positions = []nodePosition{
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-100," +
			...
			"708D2D2F-87E6-11EB-AEDB-E18E21FD8FD5:1-100"), "A", 0, 10},
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-333," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100," +
			"708D2D2F-87E6-11EB-AEDB-E18E21FD8FD5:1-100"), "B", 42, 0},
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-333," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100," +
			"708D2D2F-87E6-11EB-AEDB-E18E21FD8FD5:1-100"), "C", 5.5, 0},
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-333," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100," +
			"708D2D2F-87E6-11EB-AEDB-E18E21FD8FD5:1-100"), "D", 135, 0},
	}
	host, _, splitbrain = findMostRecentNodeAndDetectSplitbrain(positions)
	...
	positions = []nodePosition{
		...
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-100," +
			...
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100"), "C", 0, 0},
	}
	host, _, splitbrain = findMostRecentNodeAndDetectSplitbrain(positions)
	...
	positions = []nodePosition{
		...
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-100," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-000000000000:1-100"), "B", 0, 0},
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-100," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100"), "C", 0, 0},
	}
...
func TestDesirableNodeWithZeroPriorityWorksAsFindMostRecentNode(t *testing.T) {
	...
	positions = []nodePosition{
		...
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-102," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-103," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-104"), "B", 0, 0},
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-101," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-102," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-103"), "C", 0, 0},
	}
	...
	positions = []nodePosition{
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-100," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100," +
			"708D2D2F-87E6-11EB-AEDB-E18E21FD8FD5:1-100"), "A", 0, 0},
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-333," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100," +
			"708D2D2F-87E6-11EB-AEDB-E18E21FD8FD5:1-100"), "B", 42, 0},
...
func TestFindMostDesirableNodeDependsOnPriority(t *testing.T) {
	...
	positions = []nodePosition{
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-100," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100," +
			"708D2D2F-87E6-11EB-AEDB-E18E21FD8FD5:1-100"), "A", 6000, 10},
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-333," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100," +
			"708D2D2F-87E6-11EB-AEDB-E18E21FD8FD5:1-100"), "B", 42, 7},
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-333," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100," +
			"708D2D2F-87E6-11EB-AEDB-E18E21FD8FD5:1-100"), "C", 5.5, 5},
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-333," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100," +
			"708D2D2F-87E6-11EB-AEDB-E18E21FD8FD5:1-100"), "D", 135, 0},
	...
	positions = []nodePosition{
		...
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-333," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100," +
			"708D2D2F-87E6-11EB-AEDB-E18E21FD8FD5:1-100"), "B", 5990, 7},
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-333," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100," +
			"708D2D2F-87E6-11EB-AEDB-E18E21FD8FD5:1-100"), "C", 6005, 5},
		{mustGTIDSet("6DBC0B04-4B09-43DC-86CC-9AF852DED919:1-333," +
			"09978591-5754-4710-BF67-062880ABE1B4:1-100," +
			"AA6890C8-69F8-4BC4-B3A5-5D3FEA8C28CF:1-100," +
			"708D2D2F-87E6-11EB-AEDB-E18E21FD8FD5:1-100"), "D", 6600, 0},
	}
	host, _ = getMostDesirableNode(logger, positions, 50*time.Second)
	require.Equal(t, "A", host)
}
